...
<head>
    ...
    <link rel="stylesheet" href="../css/voirplus.css">
</head>
<body>
    <div class="container">
        <header>
            <nav>
                <ul>
                    <li><img src="../<?= htmlspecialchars($logo_url) ?>" alt="Logo agence"></li>
                    <li><a href="Accueil.php"><i class="fas fa-home"></i> Accueil</a></li>
                    <li><a href="tableagence.php"><i class="fas fa-table"></i> Tableau location</a></li>
